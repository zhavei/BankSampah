...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener {
            if (isOnline()) {
                ...
                Toast.makeText(applicationContext, "Kamu offline, swipe untuk reload!!", Toast.LENGTH_SHORT).show()
                snackBarError()
                webView.loadUrl(url)
            }
        }
    ...
    private fun chekInternetConnect() {
        ...
        if (isOnline()) {
            ...
            Toast.makeText(applicationContext, "Kamu offline cek internet anda!!", Toast.LENGTH_SHORT)
                .show()
